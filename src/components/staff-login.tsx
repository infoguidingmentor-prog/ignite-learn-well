 ...
 * `role_requests` and waits — admin approval is the only way to the panel.
    ...
    <div className="min-h-screen grid place-items-center bg-background px-4 py-10">
      <div className="w-full max-w-sm">
        ...
        <div className="soft-card p-7">
          ...
          {requestRole && (
            <>
              <Button type="button" variant="outline" onClick={google} disabled={busy} className="mt-6 w-full rounded-full">
